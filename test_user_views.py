...
connect_db, Message, User, Likes, Follows from bs4 import BeautifulSoup
...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u4 = User.signup("testing", "test4@test.com", "passwprd", None)
    ...
    def test_users_index(self):
        with self.client as c:
            ...
            self.assertIn("@efg", str(resp.data)), str (resp.data)
